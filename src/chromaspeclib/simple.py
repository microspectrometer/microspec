from .internal.data.command import CHROMASPEC_COMMAND_NAME
from .expert import ChromaSpecExpertInterface
...
ChromaSpecSimpleInterface.__doc__ = "".join([_generateDocstring(command) for command in CHROMASPEC_COMMAND_NAME.values()])
